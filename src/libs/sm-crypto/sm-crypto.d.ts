...
export function generateKeyPairHex(a?: any, b?: any, c?: any): KeyPairHex;
export function doSignature(msg: string | number[], privateKey: string, options?: {
...
export function doVerifySignature(msg: string | number[], signHex: string, publicKey: string, options?: {
  der?: boolean | undefined;
  hash?: boolean | undefined;
  userId?: string | undefined;
}): boolean;
export function getPoint(): KeyPairPoint;
export function comparePublicKeyHex(
  publicKey1: any,
  publicKey2: any,
): boolean | any
